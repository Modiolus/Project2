...
//    private static String[][] drawNumber(char f) { //String.valueOf(f).toCharArray()
//        // строка кода ниже позволяет предствить символ в системе счисления!
//        char[] numbers = String.valueOf(Integer.valueOf(f)).toCharArray();  //String.valueOf(Integer.valueOf(f)).toCharArray()
//        String[][] drawNumber = {{""}, {""}, {""}, {""}, {""}, {""}, {""}, {""}, {""}, {""}, {""}, {""}, {""}};
//        for (int i = 0; i < numbers.length; i++) {
//            String[][] current = choose(numbers[i]);
//            for (int j = 0; j < current.length; j++) {
